package com.waylau.hmos.javadataabilityhelperaccessfile.slice;

import com.waylau.hmos.javadataabilityhelperaccessfile.FileUtils;
import com.waylau.hmos.javadataabilityhelperaccessfile.ResourceTable;
...
public class MainAbilitySlice extends AbilitySlice {
    ...
    private void getFile() {
        ...
        // 访问数据用的URI，注意用三个斜杠
        Uri uri =
                Uri.parse("dataability:///com.waylau.hmos.javadataabilityhelperaccessfile.UserDataAbility");
