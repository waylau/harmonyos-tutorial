...
public class UserDataAbility extends Ability {
    ...
    public FileDescriptor openFile(Uri uri, String mode) {
        ...
        RawFileEntry rawFileEntry =
                this.getResourceManager().getRawFileEntry("resources/rawfile/users.txt");
        FileDescriptor fd = null;
        try {
            // 输出文件内容
            String fileContent = getFileStringContent(rawFileEntry);

            HiLog.info(LABEL_LOG, "openFile content: %{public}s", fileContent);
    ...
    // 文件内容输出为字符串
    private String getFileStringContent(RawFileEntry rawFileEntry) throws IOException {
