package com.waylau.hmos.javadataabilityhelperaccessdatabase.slice;

import com.waylau.hmos.javadataabilityhelperaccessdatabase.ResourceTable;
...
public class MainAbilitySlice extends AbilitySlice {
    ...
    private void doDatabaseAction() {
        ...
        // 访问数据用的URI，注意用三个斜杠
        Uri uri =
                Uri.parse("dataability:///com.waylau.hmos.javadataabilityhelperaccessdatabase.UserDataAbility");
        ...
        if (resultSet != null && resultSet.getRowCount() > 0) {
            ...
            while (resultSet.goToNextRow()) {
                ...
                HiLog.info(LABEL_LOG,
                        "resultSet user_id：%{public}s, user_name：%{public}s, user_age：%{public}s",
